...
class GuiaModel extends BaseModel
{
    ...
    public function saveGuia($nombre, $presentacion, $glosarioTerminos, $referentesBibliograficos, $razonCambio, $instructor, $programaFormacion, $especialidad)
    {
        try {
            $sql = "INSERT INTO $this->table (nombre, presentacion, glosarioTerminos, referentesBibliograficos, razonCambio, fkIdInstructor, fkIdProgramaFormacion, fkIdEspecialidad) VALUES (:nombre, :presentacion, :glosarioTerminos, :referentesBibliograficos, :razonCambio, :instructor, :programaFormacion, :especialidad)";
