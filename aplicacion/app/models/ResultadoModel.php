...
class ResultadoModel extends BaseModel
{
    ...
    public function saveResultado($fkIdCompetencia,$resultado)
    {
        try {
            $sql = "INSERT INTO $this->table (fkIdCompetencia, resultado) VALUES (:fkIdCompetencia, :resultado)";
            $statement = $this->dbConnection->prepare($sql);
            $statement->bindParam(':fkIdCompetencia', $fkIdCompetencia, PDO::PARAM_INT);
            $statement->bindParam(':resultado', $resultado, PDO::PARAM_INT);
